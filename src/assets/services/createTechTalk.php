...
$techtalktype=$request->techtalktype;
$speakerId=0;
$venueId=0;
$registrationId=0;
$authCode = rand();
...
$techtalkdetailsQuery="insert into techtalkdetails (techtalktype, technology, subtechnology, speakerid, originatorid, venueid, regdetailid, techtalktopic, createdby, updatedby, authcode) values('$techtalktype', $technology,$subtechnology,$speakerId,$userId,$venueId, $registrationId, '$topic',$userId,$userId, $authCode)";
//echo $techtalkdetailsQuery;
if(mysqli_query($conn,$techtalkdetailsQuery)){
    $response.=',"techtalkdetailsQuery":"done"';
}else{
    $response.=',"techtalkdetailsQuery":"failed"';
}
$techtalkId = mysqli_insert_id($conn);
...
$subject="Tech Talk Created. <Approve/Decline>";
  $headers = "MIME-Version: 1.0" . "\r\n";
  $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
  $headers .= 'From: <donotreply@edubee.com>' . "\r\n";
$approveEmailUrl="http://edubee.accrosian.com/assets/services/updateTechtalkStatus.php?techtalkId=".$techtalkId."&approvalStatus=approved&authCode=".$authCode;
$declineEmailUrl="http://edubee.accrosian.com/assets/services/updateTechtalkStatus.php?techtalkId=".$techtalkId."&approvalStatus=declined&authCode=".$authCode;
$techtalkdetail='
  <span class="cardSubHeading">Originator</span>
              ...
              <br/>
              <b>Tech Talk Type</b> : '.$techtalktype.'
                
              <br/>
    <span class="cardSubHeading">Other Details</span>
              
              <b>Tech Talk Topic</b> : '.$topic.'
          <br/>
          <b>Tech Talk Type</b> : '.$techtalktype.'
          <br/>
          ...
          <br/>
        <b>Registration Fee</b> : '.$registrationDetails->regfee.' Rs Per Person
  ';
