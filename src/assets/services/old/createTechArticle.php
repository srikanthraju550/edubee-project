...
$paidArticle = $request->paidArticle;
$cost = $request->cost;
$publicationlink = $request->publicationlink;
$userId = $request->userDetails->userid;
$articleType = $request->articleType;



  $subject="Tech Article Created. <Approve/Decline>";
...
$response.="{";
$authCode = rand();
$techarticledetailsQuery="insert into techarticledetails (email, contact, articletitle, abstract, technology, subtechnology,  articlepaymentindcd, cost, publicationlink, userid, createdby, updatedby, articletype, authcode) values('$email', $contactnumber, '$title', '$abstract', $technology, $subtechnology, '$paidArticle', $cost, '$publicationlink', $userId, $userId, $userId, '$articleType', $authCode)";
//echo $techarticledetailsQuery;
if(mysqli_query($conn,$techarticledetailsQuery)){
    $response.='"techarticledetailsQuery":"done"';
}else{
    $response.='"techarticledetailsQuery":"failed"';
}
...
$approveEmailUrl="http://edubee.accrosian.com/assets/services/updateArticleStatus.php?articleId=".$articleId."&approvalStatus=approved&authCode=".$authCode;
$declineEmailUrl="http://edubee.accrosian.com/assets/services/updateArticleStatus.php?articleId=".$articleId."&approvalStatus=declined&authCode=".$authCode;
$articleDetails='
