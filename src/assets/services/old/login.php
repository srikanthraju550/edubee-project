...
$response.="{";
//$userCheck = mysqli_query($conn,"select t1.userid, t1.username, t1.emailaddress, t2.name, t1.usertype, t1.emailverified, t1.profilepicture, getTotalFollowerCount(t1.userid) from logindetails t1, basicinformation t2 where (t1.emailaddress='$username' OR t1.username='$username') and t1.userid = t2.userid and t1.password='$password'");
