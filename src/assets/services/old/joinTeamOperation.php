...
if (!($res1=mysqli_fetch_row($alreadyRegisteredCheck))) {
    $techEventRegistrationQuery="insert into stuvationmemberdetails ( projectid, userid, rolename, createdby, updatedby) values( $projectid,  $registereduserid, '$rolename', $registereduserid, $registereduserid);";
