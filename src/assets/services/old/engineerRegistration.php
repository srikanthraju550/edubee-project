...
if (!($res1=mysqli_fetch_row($userCheck))) {
	...
	$query1="insert into logindetails (emailaddress, username, password, usertype, profilepicture, verificationCode) values('$email','$username','$password','engineer','$profilePicture', $authCode)";
