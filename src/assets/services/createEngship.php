...
$engshipType =$request->engshipType;
...
$membershipChargeFlag =$request->membershipChargeFlag;
$membershipCharge =$request->membershipCharge;
$willingToTravelFlag =$request->willingToTravelFlag;
$mentorBeforeFlag =$request->mentorBeforeFlag;
$lookingForEFSupportFlag =$request->lookingForEFSupportFlag;
$tncAcceptFlag =$request->tncAcceptFlag;
$userId = $request->userid;

$branch =$request->branch;
$college =$request->college;
$tenthPercent =$request->tenthPercent;
$plustwoPercent =$request->plustwoPercent;
$graduationPercent =$request->graduationPercent;
$postgradPercent =$request->postgradPercent;
$learningGoals = $request->learningGoals;
$lookingFor = $request->lookingFor;

  $subject="Engship Created. <Approve/Decline>";
...
$response.="{";
$authCode = rand();
$engshipdetailsMentorquery="insert into engshipdetails (
	engshipType,
	organization,
	position,
	workLocation,
	...
	timeSpend,
	numberOfHours,
	membershipChargeFlag,
	membershipCharge,
	willingToTravelFlag,
	usedServicesBeforeFlag,
	lookingForEFSupportFlag,
	tncAcceptFlag,
	lookingFor,
	mentorId,
	 createdby, updatedby, authcode) 
values('$engshipType',
'$organization',
'$position',
'$workLocation',
...
$userId,
$userId,  $authCode)";
$engshipdetailsMenteequery="insert into engshipdetails (
	engshipType,
	branch,
	college,
	tenthPercent,
...
if($lookingFor=='Mentor')
	$stuvationdetailsquery=$engshipdetailsMenteequery;
else
	$stuvationdetailsquery=$engshipdetailsMentorquery;
	echo $stuvationdetailsquery;
...
$engshipId = mysqli_insert_id($conn);
...
$approveEmailUrl="http://edubee.accrosian.com/assets/services/updateEngshipStatus.php?engshipId=".$engshipId."&approvalStatus=approved&authCode=".$authCode;
$declineEmailUrl="http://edubee.accrosian.com/assets/services/updateEngshipStatus.php?engshipId=".$engshipId."&approvalStatus=declined&authCode=".$authCode;
$articleDetails='New Mentor added. Kindly check the Admin Panel.';
$emailContent = '<head>
