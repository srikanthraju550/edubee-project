...
function ResCarouselSize() {
    ...
    $('.resCarousel').each(function(index) {
        ...
        for (var i = 0; i < 4; i++) {
            if (i == 0) {
                var styleCollector0 = ".ResSlid" + index + " .item {width: " + 75 / itemsSplit[i] + "%}";
            } else if (i == 1) {
                var styleCollector1 = ".ResSlid" + index + " .item {width: " + 75 / itemsSplit[i] + "%}";
            } else if (i == 2) {
                var styleCollector2 = ".ResSlid" + index + " .item {width: " + 75 / itemsSplit[i] + "%}";
            } else if (i == 3) {
                var styleCollector3 = ".ResSlid" + index + " .item {width: " + 75 / itemsSplit[i] + "%}";
            }
        }
...
function ResCarousel(Btn) {
    ...
    itemSpeed = !isNaN(itemSpeed) ? itemSpeed : 800;
